...
export class CommonFunctionGateway extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CommonFunctionGatewayState): CommonFunctionGateway {
        return new CommonFunctionGateway(name, <any>state, { id });
    }
