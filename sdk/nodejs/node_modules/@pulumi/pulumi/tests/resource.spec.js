...
describe("createUrn", () => {
    ...
    it("handles name and type", util_1.asyncTest(() => __awaiter(this, void 0, void 0, function* () {
        const urn = yield resource_1.createUrn("n", "t").promise();
        assert.equal(urn, "urn:pulumi:mystack::myproject::t::n");
    })));
    it("handles name and type and parent", util_1.asyncTest(() => __awaiter(this, void 0, void 0, function* () {
    ...
    it("handles name and type and parent with parent", util_1.asyncTest(() => __awaiter(this, void 0, void 0, function* () {
