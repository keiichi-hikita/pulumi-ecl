...
describe("output", () => {
    it("propagates true isKnown bit from inner Output", util_1.asyncTest(() => __awaiter(this, void 0, void 0, function* () {
        ...
        const output1 = new output_1.Output(new Set(), Promise.resolve("outer"), Promise.resolve(true), Promise.resolve(false));
        const output2 = output1.apply(v => new output_1.Output(new Set(), Promise.resolve("inner"), Promise.resolve(true), Promise.resolve(false)));
    ...
    it("propagates false isKnown bit from inner Output", util_1.asyncTest(() => __awaiter(this, void 0, void 0, function* () {
        runtime._setIsDryRun(true);
        const output1 = new output_1.Output(new Set(), Promise.resolve("outer"), Promise.resolve(true), Promise.resolve(false));
        const output2 = output1.apply(v => new output_1.Output(new Set(), Promise.resolve("inner"), Promise.resolve(false), Promise.resolve(false)));
        const isKnown = yield output2.isKnown;
    ...
    it("can await even when isKnown is a rejected promise.", util_1.asyncTest(() => __awaiter(this, void 0, void 0, function* () {
        runtime._setIsDryRun(true);
        const output1 = new output_1.Output(new Set(), Promise.resolve("outer"), Promise.resolve(true), Promise.resolve(false));
        const output2 = output1.apply(v => new output_1.Output(new Set(), Promise.resolve("inner"), Promise.reject(new Error()), Promise.resolve(false)));
        const isKnown = yield output2.isKnown;
        assert.equal(isKnown, false);
        try {
            const value = yield output2.promise();
    ...
    it("propagates true isSecret bit from inner Output", util_1.asyncTest(() => __awaiter(this, void 0, void 0, function* () {
        runtime._setIsDryRun(true);
        const output1 = new output_1.Output(new Set(), Promise.resolve("outer"), Promise.resolve(true), Promise.resolve(false));
        const output2 = output1.apply(v => new output_1.Output(new Set(), Promise.resolve("inner"), Promise.resolve(true), Promise.resolve(true)));
        const isSecret = yield output2.isSecret;
        assert.equal(isSecret, true);
        const value = yield output2.promise();
        assert.equal(value, "inner");
    })));
    it("retains true isSecret bit from outer Output", util_1.asyncTest(() => __awaiter(this, void 0, void 0, function* () {
        runtime._setIsDryRun(true);
        const output1 = new output_1.Output(new Set(), Promise.resolve("outer"), Promise.resolve(true), Promise.resolve(true));
        const output2 = output1.apply(v => new output_1.Output(new Set(), Promise.resolve("inner"), Promise.resolve(true), Promise.resolve(false)));
        const isSecret = yield output2.isSecret;
        assert.equal(isSecret, true);
        const value = yield output2.promise();
