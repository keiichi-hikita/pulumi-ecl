...
class OutputImpl {
    /** @internal */
    constructor(resources, promise, isKnown, isSecret) {
        /**
         * @internal
...
This function may throw in a future version of @pulumi/pulumi.`;
        ...
        this.apply = (func) => {
            let innerDetailsResolve;
            const innerDetails = new Promise(resolve => {
            ...
            return new exports.Output(resources, promise.then((v) => __awaiter(this, void 0, void 0, function* () {
                try {
                    ...
                    if (exports.Output.isInstance(transformed)) {
                        ...
                        innerDetailsResolve({
                            isKnown: yield transformed.isKnown,
                            isSecret: yield (transformed.isSecret || Promise.resolve(false)),
                        });
...
function isSecretOutput(o) {
    return exports.Output.isInstance(o.isSecret) ? Promise.resolve(false) : o.isSecret;
}
...
function output(val) {
    if (val === null || typeof val !== "object") {
        ...
        return new exports.Output(new Set(), val, /*isKnown*/ Promise.resolve(true), /*isSecret*/ Promise.resolve(false)).apply(output);
    }
...
function secret(val) {
    const o = output(val);
    return new exports.Output(o.resources(), o.promise(), o.isKnown, Promise.resolve(true));
}
exports.secret = secret;
function createSimpleOutput(val) {
    return new exports.Output(new Set(), Promise.resolve(val), 
...
function all(val) {
    if (val instanceof Array) {
        ...
        return new exports.Output(new Set(resources), promisedArray, isKnown, isSecret);
    }
    else {
        ...
        return new exports.Output(new Set(resources), promisedObject, isKnown, isSecret);
    }
}
exports.all = all;
...
function getResourcesAndDetails(allOutputs) {
