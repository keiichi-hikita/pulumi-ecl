...
declare type Resolved<T> = T extends Promise<infer U1> ? ResolvedSimple<U1> : T extends OutputInstance<infer U2> ? ResolvedSimple<U2> : ResolvedSimple<T>;
...
declare type KeyOf = string | number | symbol;
declare type Diff<T extends KeyOf, U extends KeyOf> = ({
    [P in T]: P;
} & {
    [P in U]: never;
} & {
...
declare type Omit<T, K extends KeyOf> = Pick<T, Diff<keyof T, K>>;
export {};
