...
function reportModuleLoadFailure(program, error) {
    ...
    return process.exit(exports.nodeJSProcessExitedAfterLoggingUserActionableMessage);
}
...
function run(opts) {
    ...
    process.on("exit", settings_1.disconnectSync);
    opts.programStarted();
    ...
    return opts.runInStack ? stack_1.runInPulumiStack(runProgram) : Promise.resolve(runProgram());
}
exports.run = run;
