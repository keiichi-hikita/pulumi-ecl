...
class Stack extends resource_1.ComponentResource {
    constructor(init) {
        ...
        this.outputs = output_1.output(this.runInit(init));
    }
    /**
    ...
    runInit(init) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                // Resources.
                _super.registerOutputs.call(this, massage(outputs, new Set()));
            }
            return outputs;
        });
    }
...
function massage(prop, seenObjects) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (output_1.Output.isInstance(prop)) {
            ...
            // marked as secret.
            const isSecret = yield (prop.isSecret || Promise.resolve(false));
            const value = yield massage(yield prop.promise(), seenObjects);
            if (isSecret) {
                return output_1.secret(value);
            }
            return value;
        }
