...
def get_dns_zone(attributes=None, created_at=None, description=None, domain_name=None, email=None, masters=None, name=None, pool_id=None, project_id=None, region=None, serial=None, status=None, transferred_at=None, ttl=None, type=None, updated_at=None, version=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('ecl:dns/getDnsZone:getDnsZone', __args__)
