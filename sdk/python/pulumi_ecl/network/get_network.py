...
def get_network(description=None, matching_subnet_cidr=None, name=None, network_id=None, plane=None, status=None, subnets=None, tags=None, tenant_id=None):
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('ecl:network/getNetwork:getNetwork', __args__)
