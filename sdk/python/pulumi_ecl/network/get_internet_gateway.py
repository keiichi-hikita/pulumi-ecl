...
async def get_internet_gateway(description=None, internet_gateway_id=None, internet_service_id=None, name=None, qos_option_id=None, region=None, status=None, tenant_id=None):
    __args__ = dict()
    ...
    __ret__ = await pulumi.runtime.invoke('ecl:network/getInternetGateway:getInternetGateway', __args__)
