...
def get_subnet(cidr=None, description=None, enable_dhcp=None, gateway_ip=None, ip_version=None, ipv6_address_mode=None, ipv6_ra_mode=None, name=None, network_id=None, ntp_servers=None, status=None, subnet_id=None, tags=None, tenant_id=None):
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('ecl:network/getSubnet:getSubnet', __args__)
